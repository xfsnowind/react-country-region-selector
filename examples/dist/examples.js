...
var CountryDropdown = (function (_React$Component) {
  ...
  _createClass(CountryDropdown, [{
    ...
    value: function getPriorSeparator() {
      if (this.state.priorCountries.length > 0) {
        return _react2['default'].createElement('option', { value: 'separator', disabled: true }, '--------------------');
      }
      return null;
    }
  }, {
    ...
    value: function getDefaultOption() {
      ...
      return _react2['default'].createElement('option', { value: '', key: 'default', disabled: true }, defaultOptionLabel);
    }
  }, {
    ...
    value: function getPriorityOption() {
      ...
      return _react2['default'].createElement('option', { value: '', disabled: true }, priorListLabel);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2['default'].createElement('select', attrs, this.getDefaultOption(), this.getPriorityOption(), this.getPriorCountries(), this.getPriorSeparator(), this.getCountries());
    }
  }]);
